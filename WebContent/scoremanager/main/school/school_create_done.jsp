  ...
  <c:param name="content">
    ...
    <section class="me-4">
	  ...
	  <div style="margin-left: 1rem; margin-top: 5rem;">
        <a href="SchoolCreate.action" style="margin-right: 1.5rem; color: #007bff; text-decoration: none;">戻る</a>
        <a href="SchoolList.action" style="color: #007bff; text-decoration: none;">学校一覧</a>
      </div>
    </section>
  </c:param>
</c:import>
